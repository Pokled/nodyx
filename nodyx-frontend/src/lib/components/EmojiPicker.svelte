<script lang="ts">
	...
	const UNICODE = [
		{ label: '😀', name: 'emoji_picker.cat_smileys', emojis: ['😀','😃','😄','😁','😆','😅','🤣','😂','🙂','🙃','😉','😊','😇','🥰','😍','🤩','😘','😋','😛','😜','🤪','😝','🤑','🤗','🤭','🤔','🤐','🤨','😐','😑','😶','😏','😒','🙄','😬','😔','😪','🤤','😴','😷','🤒','🤕','🤢','🤮','🤧','🥵','🥶','🥴','😵','🤯','🤠','🥳','😎','🤓','🧐','😕','😟','🙁','😮','😯','😲','😳','🥺','😦','😧','😨','😰','😥','😢','😭','😱','😖','😣','😞','😓','😩','😫','🥱','😤','😡','😠','🤬','😈','👿','💀','☠️','💩','🤡','👹','👺','👻','👽','🤖'] },
		{ label: '👋', name: 'emoji_picker.cat_gestes', emojis: ['👋','🤚','🖐️','✋','🖖','👌','🤌','✌️','🤞','🤟','🤘','🤙','👈','👉','👆','👇','☝️','👍','👎','✊','👊','🤛','🤜','👏','🙌','🤝','🙏','💪','💅','🤳','👀','👁️','👅','👄','🫶','🫵','🫰','🤙'] },
		{ label: '❤️', name: 'emoji_picker.cat_coeurs', emojis: ['❤️','🧡','💛','💚','💙','💜','🖤','🤍','🤎','💔','❤️‍🔥','❣️','💕','💞','💓','💗','💖','💘','💝','✨','⭐','🌟','💫','🔥','💥','❄️','🌈','☀️','🌙','⚡','💦','🌊','🎉','🎊','🎈','🎁','🏆','🥇','🎯','🎮','🎲','🧩','🎭','🎨','🎬','🎤','🎧','🎶','🎵'] },
		{ label: '🐶', name: 'emoji_picker.cat_animaux', emojis: ['🐶','🐱','🐭','🐹','🐰','🦊','🐻','🐼','🐨','🐯','🦁','🐮','🐷','🐸','🐵','🙈','🙉','🙊','🐔','🐧','🐦','🦆','🦅','🦉','🦇','🐺','🐴','🦄','🐝','🐛','🦋','🐌','🐞','🐜','🐢','🦎','🐍','🐊','🐅','🐆','🦓','🐘','🦛','🦒','🦘','🐕','🐈','🐟','🐬','🐳','🦈','🐙','🦀','🦑','🦜','🦚','🦩','🕊️'] },
		{ label: '🍕', name: 'emoji_picker.cat_nourriture', emojis: ['🍕','🍔','🌮','🌯','🥙','🍣','🍱','🍜','🍝','🍛','🍲','🥗','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🥪','🧀','🥚','🍿','🧂','🍦','🍧','🍨','🍩','🍪','🎂','🍰','🧁','🍫','🍬','🍭','☕','🍵','🧋','🥤','🍺','🍻','🍷','🥂','🍸','🍹','🧃','🧊','🍓','🍇','🍉','🍊','🍋','🍌','🍍','🥭','🍎','🍏','🍐','🍑','🫐'] },
		{ label: '🚀', name: 'emoji_picker.cat_voyage', emojis: ['🚀','✈️','🛸','🚂','🚗','🏎️','🚕','🚌','🚑','🚒','🛵','🏍️','🚲','⛵','🚤','🚢','🛩️','🚁','🗺️','🗼','🏰','🏯','🗽','🗻','🏔️','🌋','🏕️','🏖️','🏜️','🏝️','🏠','🏡','🏢','🏥','🏦','🏨','🏪','🏫','🏬','🏭','💒','🌍','🌎','🌏','🌐','🗾','🧭'] },
		{ label: '💡', name: 'emoji_picker.cat_objets', emojis: ['💡','🔦','📱','💻','🖥️','⌨️','📺','📷','📹','🎥','📞','☎️','📡','🔋','🔌','🔑','🗝️','🔐','🔒','🔓','🔨','⚙️','🔧','🔩','🔗','🧲','🧰','📦','📫','📝','📌','📍','✂️','🔍','🔎','🔬','🔭','💊','🩹','🩺','🧬','🎵','🎶','🎸','🎹','🥁','🎺','🎷','🎻','📚','📖','📰','🗞️','📋','📊','📈','📉','🗒️','🗓️'] },
		{ label: '✅', name: 'emoji_picker.cat_symboles', emojis: ['✅','❌','⚠️','💯','🔴','🟠','🟡','🟢','🔵','🟣','⚫','⚪','🟤','🆕','🆓','🆗','🆙','🆒','ℹ️','🔔','🔕','📢','📣','🔊','🔇','🔀','🔁','🔂','▶️','⏸️','⏭️','⏮️','⏩','⏪','⬆️','⬇️','⬅️','➡️','↕️','↔️','🔄','♻️','🚫','⛔','❓','❗','‼️','⁉️','💤','🔅','🔆','📶','📳','📴','📵','📱','🔐','🔏'] },
	];
...
<div class="bg-gray-900 border border-gray-700 rounded-xl shadow-2xl overflow-hidden" style="width: 320px;">
	...
	{#if !searching}
		<div class="flex border-b border-gray-800 bg-gray-950/80">
			{#each tabs as cat, i}
				{#if cat.type === 'custom'}
					<button onclick={() => (activeCategory = i)} title={tFn(cat.name)}
					...
					><span class="text-sm">{cat.label}</span> {tFn(cat.name)}</button>
				{:else}
					<button onclick={() => (activeCategory = i)} title={tFn(cat.name)}
